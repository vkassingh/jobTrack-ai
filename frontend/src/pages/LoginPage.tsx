        ...
        <div className="bg-surface-container-lowest rounded-xl border border-outline-variant shadow-[0_4px_12px_rgba(0,0,0,0.03)] px-xl py-xl flex flex-col gap-xl">
          ...
          <div className="flex flex-col items-center text-center gap-sm">
            ...
            <div className="flex flex-col gap-xs mt-sm">
              <h1 className="font-h2 text-h2 text-on-surface">Log in to your account</h1>
              <p className="font-body-md text-body-md text-on-surface-variant">Track your job applications with AI</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-lg">
            ...
            <div className="flex flex-col gap-sm">
              <div className="flex items-center justify-between">
                ...
                <a className="font-label-sm text-label-sm text-primary hover:underline underline-offset-4" href="#">
                  Forgot password?
                </a>
              </div>
          ...
          <p className="text-center font-body-md text-body-md text-on-surface-variant">
            ...
            <Link className="text-primary font-semibold hover:underline underline-offset-4" to="/register">
              Sign up
            </Link>
          </p>
        </div>
